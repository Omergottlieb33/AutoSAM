...
def main(args):
    ...
    gt_path = args['gt_path']  # path to the ground truth masks
    npy_path = os.path.join(args['npy_path'], prefix[:-1])
...
if __name__ == '__main__':
    ...
    # this file is taken from MedSam and modified to fit the current project
